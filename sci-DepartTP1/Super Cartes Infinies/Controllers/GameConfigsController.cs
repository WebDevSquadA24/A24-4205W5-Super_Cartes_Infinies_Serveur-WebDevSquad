...
namespace Super_Cartes_Infinies.Controllers
{
    ...
    public class GameConfigsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NbCardsToDraw,NbManaToReceive,BeginnerMoney,WinnerMoney,LoserMoney")] GameConfig gameConfig)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NbCardsToDraw,NbManaToReceive,BeginnerMoney,WinnerMoney,LoserMoney")] GameConfig gameConfig)
        {
            if (id != gameConfig.Id)
            {
                return NotFound();
